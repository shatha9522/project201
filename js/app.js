...
//var favfootballteam = prompt('What Is Your Favourite Football Team ?');
//console.log('My Favourite football team is ', favfootballteam);

//var socialmediatime = prompt('How Much Time Do You spend on Social Media ?');
//console.log('Social Media Time', socialmediatime + 'hours');

//var favplace = prompt('Sea or Mountain ?');
//console.log('My favourite place is', favplace );
